                        ...
                        <div className="relative h-full flex flex-col overflow-hidden">
                            ...
                            <div className="mt-auto">
                                ...
                                <div className="pt-3 pb-3 bg-gray-50/50 dark:bg-black/20 flex justify-between items-center text-xs text-gray-400 font-medium px-4">
                                    ...
                                    {folder.template_count !== undefined && (
                                        <div className="flex items-center gap-2">
                                            <FileText className="w-3.5 h-3.5" />
                                            <span>{folder.template_count} 個範本</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                ...
                <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                        <DialogTitle className="font-serif text-xl">
                            上傳範本到「{uploadFolderId === "all" ? '所有範本' : folders.find(f => f.id === uploadFolderId)?.name || '所有範本'}」
                        </DialogTitle>
                        <DialogDescription>
                            選擇要上傳的 Word 範本檔案 (.docx)。
                        </DialogDescription>
                    </DialogHeader>
                    <UploadTemplateZone
                        folders={folders}
